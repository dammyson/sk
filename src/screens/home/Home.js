...
export default class Home extends Component {
                ...
                <View style={{ flex: 1, backgroundColor: lightTheme.WHITE_COLOR }}>
                    ...
                    <View style={{
                        ...
                        <View style={{ justifyContent: 'flex-start', alignItems: 'flex-start', flex: 1, paddingRight: 5, marginTop: 40, marginBottom: 20, }}>
                            <Text numberOfLines={1} style={{ fontSize: 12, color: lightTheme.PRIMARY_COLOR }}>Halla, </Text>
                            <Text numberOfLines={1} style={{ fontSize: 20, fontFamily: font.BOLD }}>Abdul</Text>
                        </View>
            ...
            <View style={{ flex: 1, }}>
                ...
                <View style={{ marginHorizontal: 20 }}>
                    <LinearGradient
                        ...
                        colors={["#26A594", lightTheme.PRIMARY_COLOR]}>
                        <View style={{ height: 85, flexDirection: 'row' }}>
                            <View style={{}}>
                                <View style={[{ margin: 2, padding: 10, borderRadius: 40, backgroundColor: '#FFFFFF20', marginTop: 10, marginLeft: 10, },]}>
                                    <Icon
                                        active
                                        name="setting"
                                        type='antdesign'
                            ...
                            <View style={{ flex: 1, marginVertical: 15, marginLeft: 15 }}>
                                <Text style={{ color: lightTheme.WHITE_COLOR, fontFamily: font.LIGHT, fontSize: 14 }}>Add Property </Text>
                                <Text style={{ color: lightTheme.WHITE_COLOR, fontFamily: font.BOLD, fontSize: 18 }}>90% </Text>
                            </View>

                            <View style={{}}>
                                <View style={{ alignItems: 'center', marginTop: 10, marginRight: 20, flexDirection: 'row', backgroundColor: '#fff', padding: 10, paddingVertical: 5, borderRadius: 20 }}>
                                    <Text style={{ color: '#E52626', fontSize: 12 }}>20% </Text>
                                    <Icon
                                        active
                                        name="arrow-downward"
                                        type='material'
                ...
                <View style={{ flexDirection: 'row', marginHorizontal: 20, marginTop: 15 }}>
                    <View style={{ height: 85, flexDirection: 'row', backgroundColor: '#E8F8FC', flex: 1 }}>
                        <View style={{}}>
                            <View style={[{ margin: 2, padding: 10, borderRadius: 40, backgroundColor: lightTheme.PRIMARY_COLOR, marginTop: 10, marginLeft: 10, },]}>
                                <Icon
                                    active
                                    name="checkcircleo"
                                    type='antdesign'
                        ...
                        <View style={{ flex: 1, marginVertical: 15, marginLeft: 15 }}>
                            <Text style={{ color: lightTheme.PRIMARY_COLOR, fontFamily: font.LIGHT, fontSize: 14 }}>Properties </Text>
                            <Text style={{ color: lightTheme.PRIMARY_COLOR, fontFamily: font.BOLD, fontSize: 18 }}>123</Text>
                        </View>
                    ...
                    <View style={{ height: 85, flexDirection: 'row', backgroundColor: '#E8F8FC', flex: 1, marginLeft: 10, }}>
                        <View style={{}}>
                            <View style={[{ margin: 2, padding: 10, borderRadius: 40, backgroundColor: lightTheme.SECONDARY_COLOR, marginTop: 10, marginLeft: 10, },]}>
                                <Icon
                                    active
                                    name="home"
                                    type='antdesign'
                        ...
                        <View style={{ flex: 1, marginVertical: 15, marginLeft: 15 }}>
                            <Text style={{ color: lightTheme.SECONDARY_COLOR, fontFamily: font.LIGHT, fontSize: 14 }}>Rental Income  </Text>
                            <Text style={{ color: lightTheme.SECONDARY_COLOR, fontFamily: font.BOLD, fontSize: 18 }}>100,116</Text>
                        </View>
    ...
    renderCard(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            cat.push(
                <TouchableOpacity onPress={() => this.props.navigation.navigate('details', { id: link })} style={{ width: Dimensions.get('window').width / 1.5, height: Dimensions.get('window').width / 1.7, borderRadius: 20, marginHorizontal: 10, }} >
                    <ImageBackground
                        style={{ borderRadius: 12, width: Dimensions.get('window').width / 1.5, height: Dimensions.get('window').width / 1.5, }}
                    ...
                    >
                        ...
                        <LinearGradient
                            ...
                            <View style={{ width: Dimensions.get('window').width / 1.5, height: Dimensions.get('window').width / 1.5, }} >
