            ...
            <View style={styles.container}>
              ...
              <View style={{ flex: 1, }}>
                ...
                <View style={{}}>
                  ...
                  <Text numberOfLines={1} style={{ fontSize: 20, fontFamily: font.BOLD }}>Verify Passcode </Text>

                </View>

                <View style={{ flexDirection: 'row', justifyContent: 'flex-start', marginHorizontal: 20, marginTop: 10, alignItems: 'center', }}>
                  <Text numberOfLines={2} style={{ fontSize: 14, color: lightTheme.SECONDARY_TEXT_COLOR, fontFamily: font.REGULAR }}>Verify your passcode to finish signing in  </Text>
                </View>
